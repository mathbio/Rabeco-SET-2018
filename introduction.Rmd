...
Lmap <- function(a, X0, K=rep(1,steps), steps){
...
## Model não não-linear de série temporal
...
* Pacote rEDM: https://cran.r-project.org/package=rEDM
* Tutoriais Grupo MathBio: https://mathbio.github.io/edmTutorials/
* Este simpósio: https://github.com/mathbio/Rabeco-SET-2018
